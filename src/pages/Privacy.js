  ...
  render() {
    return (
        ...
        <div>
          <Helmet>
            <meta charSet='utf-8' />
            <title>Privacy | The TKM Show</title>
            <link rel='canonical' href='https://thetkmshow.in/privacy' />
          </Helmet>
          <div style={this.conatiner}>
            ...
            <div style={this.content}>
              <p>
                <span>Effective date: October 1, 2020</span>
              </p>
              <p>
                <span>
                  The TKM Show ("us", "we", or "our") operates the https://thetkmshow.in website and the &ldquo;The TKM
                  Show&rsquo;&rsquo; mobile application (the "Service").
                </span>
              </p>
              <p>
                <span>
              ...
              <p>
                <span>
                  When you access the Service by or through a mobile device, this Usage Data may include information
              ...
              <p>
                <span>The TKM Show uses the collected data for various purposes:</span>
              </p>
              <ul>
                <li>
                ...
                <li>
                  <span>To provide analysis or valuable information so that we can improve the Service</span>
                </li>
                <li>
              ...
              <p>
                <span>
                  Your information, including Personal Data, may be transferred to and maintained on the computers
              ...
              <p>
                <span>
                  The TKM Show will take all steps reasonably necessary to ensure that your data is treated securely and
              ...
              <p>
                <span>
                  Th eTKM Show may disclose your Personal Data in the good faith belief that such action is necessary
                  to:
                </span>
              </p>
              <ul>
                ...
                <li>
                  <span>To protect and defend the rights or property of The TKM Show</span>
                </li>
                <li>
              ...
              <p>
                <span>Our Service does not address anyone under the age of 18 ("Children").</span>
              </p>
              <p>
                <span>
              ...
              <ul>
                <li>
                  <span>By email: thetkmshow@gmail.com</span>
                </li>
              </ul>
            </div>
          </div>
