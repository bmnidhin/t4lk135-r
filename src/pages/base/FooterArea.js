      ...
      <div>
        <div style={this.top} className=''>
          <div className='d-flex flex-row bd-highlight mb-3 justify-content-center'>
            ...
            <div className='p-2 bd-highlight'>
              <a href='https://open.spotify.com/show/7tmPClseHqoHF5bFYT0F2o' target='_blank' rel='noopener noreferrer'>
                <i className='fa fa-spotify nbm-logo'></i> Spotify
              </a>
            </div>
            <div className='p-2 bd-highlight'>
              <a href='https://www.instagram.com/_thetkmshow_/' target='_blank' rel='noopener noreferrer'>
                <i className='fa fa-instagram nbm-logo'></i> Follow
              </a>
            </div>
          </div>
          <div className='d-flex flex-row bd-highlight mb-3 justify-content-center'>
            <div className='p-2 bd-highlight'>© thetkmshow</div>
          </div>
        </div>
      </div>
    )
