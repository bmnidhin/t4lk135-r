          ...
          <div style={this.conatiner}>
            ...
            <div style={this.content}>
              <div style={{marginTop: '30px', paddingBottom: '30px'}}>
                ...
                <table class='table table-dark mt-3 mb-3' style={{backgroundColor: '#03022900', cursor: 'pointer'}}>
                  <tbody>
                    <tr>
                      ...
                      <td style={{fontSize: '1rem', width: '70%'}}>
                        <Link
                          to={this.props.nowPlaying ? this.props.nowPlaying.slug : '/live'}
                          style={{color: 'white'}}>
                ...
                {this.props.queue.tracks && <h6 className={'text-muted'}>Up Next</h6>}
                {this.props.queue.tracks &&
                  this.props.queue.tracks.slice(this.props.currentIndex + 1, 100).map(
                    (track) =>
                      this.props.nowPlaying.slug !== track.slug && (
                        <table
                          ...
                          <tbody>
                            <tr>
                              <td scope='row' style={{width: '50px'}}>
                                <img src={track.cover} width='50px' className='roundedImage'></img>
                              </td>
                              <td style={{fontSize: '1rem', width: '70%'}}>
...
//   };
// };
export default connect(mapStateToProps, {removeQueue})(Queue)
